...
class TestULogCreation(unittest.TestCase):  # pylint: disable=too-many-public-methods
    """
    ...
    def test_add_data_message_missing_fields(self):
    ...
    def test_create_missing_required_params(self):
        ...
        with self.assertRaises(TypeError):
            pyulog.ULog.create()  # pylint: disable=no-value-for-parameter

        with self.assertRaises(TypeError):
            pyulog.ULog.create(sys_name='PX4')  # pylint: disable=no-value-for-parameter
    ...
    def test_add_data_bulk_missing_fields(self):
